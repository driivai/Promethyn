...
| 2 | 10 | `docs/OPEN-GAPS.md:2984` | refused, not degraded: a state the guard cannot establish is written as a refusal, not a clean one |
...
| 11 | 23 | `docs/OPEN-GAPS.md:5317` | counts come from the artifact, never from a filtered view of it (below) |
